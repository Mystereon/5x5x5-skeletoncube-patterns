...
The current CubeFXWeb selector has expanded to **56 embedded modes**. The first next-wave suite adds Reactor Core, Reactor Core Meltdown, Targeting System, Phosphor Green Radar, Ghost Detector, Alert, Intersecting Planes, Oscillating Wave Field, Rainbow Spiral, and Plasma Entity Containment, all with purpose-built rear-ring illumination. CubeFXPhone now exposes **73 selections** and restores a direct Next Pattern button, full everyday LIVE controls, useful firmware/wiring/Watch/support routes, and an Owner Easter Eggs deck with one-tap scene triggers.
