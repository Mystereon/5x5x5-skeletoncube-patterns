# 19_ConwayLife — Conway 3-D Life

B5/S45 three-dimensional cellular automaton.
...
Open `19_ConwayLife.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
