/*
  ...
  36_FairiesInGreenBox.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: Drifting wing-pulsing fairy lights in a green wireframe enclosure.
...
Pattern currentPattern = PATTERN_FAIRY_BOX;
