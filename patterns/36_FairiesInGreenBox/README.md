# 36_FairiesInGreenBox — Fairies in Green Box

Wing-pulsing fairies drift in a green wireframe enclosure.
...
Open `36_FairiesInGreenBox.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
