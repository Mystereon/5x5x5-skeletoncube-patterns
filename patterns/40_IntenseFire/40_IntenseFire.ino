/*
  ...
  40_IntenseFire.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: High-energy orange-and-gold fire volume.
...
Pattern currentPattern = PATTERN_INTENSE_FIRE;
