# 50_StargateDialUp — Stargate Dial-Up

Stone base, seven locking chevrons, and a blue portal opening sequence.
...
Open `50_StargateDialUp.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
