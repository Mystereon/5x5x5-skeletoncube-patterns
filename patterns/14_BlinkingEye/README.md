# 14_BlinkingEye — Blinking Eye

A tracked 3-D eye that periodically blinks.
...
Open `14_BlinkingEye.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
