# 55_LissajousRipple — Lissajous Layer Ripple

A 3-D Lissajous trace resting on layer 3, with crests rippling only into layers 2 and 4.
...
Open `55_LissajousRipple.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
