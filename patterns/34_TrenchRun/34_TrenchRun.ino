/*
  ...
  34_TrenchRun.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: Blue-grey tunnel, red target, and white pilot reticle.
...
Pattern currentPattern = PATTERN_TRENCH_RUN;
