# 33_ParallaxStarfield — Parallax Starfield

Three star layers create animated depth.
...
Open `33_ParallaxStarfield.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
