# 01_RedVectorCube — Red Vector Cube

Rotating red 3×3×3 vector wireframe.
...
Open `01_RedVectorCube.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
