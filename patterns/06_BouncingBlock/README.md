# 06_BouncingBlock — Bouncing 2×2×2 Block

Solid 2×2×2 cube bouncing within the volume.
...
Open `06_BouncingBlock.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
