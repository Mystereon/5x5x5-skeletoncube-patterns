/*
  ...
  44_PixelPasture.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: Green field, brown pixel cows, clouds, and a layer-five sun.
...
Pattern currentPattern = PATTERN_PIXEL_PASTURE;
