/*
  ...
  42_Explosions.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: Repeated expanding explosion shells with fade-off.
...
Pattern currentPattern = PATTERN_EXPLOSIONS;
