# 28_WrappingComets — Wrapping Comets

Multiple 3-D comets wrapping over all axes.
...
Open `28_WrappingComets.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
