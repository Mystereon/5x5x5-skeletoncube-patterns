# 07_BlueRain — Blue Rain

Sparse blue rain falling downward through the cube.
...
Open `07_BlueRain.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
