/*
  ...
  43_LaunchingFireworks.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: Rockets launch upward and burst across the top.
...
Pattern currentPattern = PATTERN_FIREWORKS;
