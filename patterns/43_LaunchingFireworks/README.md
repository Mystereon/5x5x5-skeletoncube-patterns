# 43_LaunchingFireworks — Launching Fireworks

Rockets launch upward and burst across the top.
...
Open `43_LaunchingFireworks.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
