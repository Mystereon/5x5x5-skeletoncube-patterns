/*
  ...
  32_BlockRun.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: A hopping red runner crossing a scrolling grass-and-block course.
...
Pattern currentPattern = PATTERN_BLOCK_RUN;
