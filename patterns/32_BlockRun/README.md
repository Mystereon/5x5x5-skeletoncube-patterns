# 32_BlockRun — Block Run

A hopping red runner crosses a scrolling grass-and-block level.
...
Open `32_BlockRun.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
