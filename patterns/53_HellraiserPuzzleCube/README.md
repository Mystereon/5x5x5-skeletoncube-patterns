# 53_HellraiserPuzzleCube — Hellraiser Puzzle Cube

Dark brass labyrinth cube with blue seams, amber glyphs, and mechanical phases.
...
Open `53_HellraiserPuzzleCube.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
