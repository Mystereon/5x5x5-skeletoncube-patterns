# 11_WhiteGlitter — White Glitter

Random white voxel sparkle with trails.
...
Open `11_WhiteGlitter.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
