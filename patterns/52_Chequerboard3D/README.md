# 52_Chequerboard3D — 3-D Chequerboard

Negative-space chequer planes fold and transform through the cube.
...
Open `52_Chequerboard3D.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
