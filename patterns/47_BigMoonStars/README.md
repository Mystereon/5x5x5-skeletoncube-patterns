# 47_BigMoonStars — Big Moon & Stars

A large shaded moon surrounded by gently twinkling blue stars.
...
Open `47_BigMoonStars.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
