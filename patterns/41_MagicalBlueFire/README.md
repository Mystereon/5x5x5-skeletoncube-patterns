# 41_MagicalBlueFire — Magical Blue Fire

Magical deep-blue and azure fire volume.
...
Open `41_MagicalBlueFire.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
