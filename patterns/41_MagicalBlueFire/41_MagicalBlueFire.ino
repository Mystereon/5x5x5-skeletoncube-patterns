/*
  ...
  41_MagicalBlueFire.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: Magical deep-blue and azure fire volume.
...
Pattern currentPattern = PATTERN_BLUE_FIRE;
