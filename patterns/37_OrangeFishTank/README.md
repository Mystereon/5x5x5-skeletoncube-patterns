# 37_OrangeFishTank — Orange Fish Tank

Blue-framed water volume with orange fish.
...
Open `37_OrangeFishTank.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
