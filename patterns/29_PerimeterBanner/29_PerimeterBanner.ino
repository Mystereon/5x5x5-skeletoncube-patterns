/*
  ...
  29_PerimeterBanner.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: 3×5 or 5×5 exterior text banner, defaulting to CUBE 4 3 2 1 0.
...
Pattern currentPattern = PATTERN_BANNER;
