/*
  ...
  38_ThreeLayerPyramid.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: A 3×3 base, 2×2 middle tier, and pulsing apex.
...
Pattern currentPattern = PATTERN_PYRAMID;
