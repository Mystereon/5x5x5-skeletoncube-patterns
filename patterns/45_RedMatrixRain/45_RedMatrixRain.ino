/*
  ...
  45_RedMatrixRain.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: Straight-down bright red heads with deep crimson fading trails.
...
Pattern currentPattern = PATTERN_RED_MATRIX_RAIN;
