# 31_PaddedCell — Padded Cell

Red pixel ricochets inside a dim-grey 3×3×3 chamber.
...
Open `31_PaddedCell.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
