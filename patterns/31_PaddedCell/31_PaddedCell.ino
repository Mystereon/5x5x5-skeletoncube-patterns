/*
  ...
  31_PaddedCell.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: A red pixel bouncing inside a dim-grey 3×3×3 padded chamber.
...
Pattern currentPattern = PATTERN_PADDED_CELL;
