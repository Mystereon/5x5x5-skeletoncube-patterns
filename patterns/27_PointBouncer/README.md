# 27_PointBouncer — Single-Point Bouncer

Single bright voxel ricocheting through the volume.
...
Open `27_PointBouncer.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
