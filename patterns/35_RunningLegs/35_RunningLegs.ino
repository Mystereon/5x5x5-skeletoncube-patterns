/*
  ...
  35_RunningLegs.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: Alternating voxel knees and wide-stepping feet.
...
Pattern currentPattern = PATTERN_RUNNING_LEGS;
