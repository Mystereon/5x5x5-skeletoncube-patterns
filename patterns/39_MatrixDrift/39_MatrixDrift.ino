/*
  ...
  39_MatrixDrift.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: The intentional diagonal deep-green Matrix wash.
...
Pattern currentPattern = PATTERN_MATRIX_DRIFT;
