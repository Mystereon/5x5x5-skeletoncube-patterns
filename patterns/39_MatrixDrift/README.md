# 39_MatrixDrift — Matrix Drift

Intentional diagonal deep-green Matrix wash.
...
Open `39_MatrixDrift.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
