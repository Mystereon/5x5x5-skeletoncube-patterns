/*
  ...
  30_BulletWall.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: Red particles colliding with a single grey plate.
...
Pattern currentPattern = PATTERN_BULLET_WALL;
