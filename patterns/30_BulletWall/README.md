# 30_BulletWall — Bullet Wall

Red particles collide with one grey plate and throw impact sparks.
...
Open `30_BulletWall.ino` in Arduino IDE and upload to the ESP32-C3. Defaults: 125 GRB
