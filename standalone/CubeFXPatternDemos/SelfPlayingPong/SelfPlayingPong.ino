/*
  ...
  SelfPlayingPong.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: A single ball with opposing voxel paddles.
...
Pattern currentPattern = PATTERN_PONG;
