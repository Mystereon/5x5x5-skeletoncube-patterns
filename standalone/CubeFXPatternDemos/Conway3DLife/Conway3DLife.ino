/*
  ...
  Conway3DLife.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: B5/S45 three-dimensional cellular automaton.
...
Pattern currentPattern = PATTERN_LIFE;
