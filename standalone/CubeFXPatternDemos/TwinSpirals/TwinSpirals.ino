/*
  ...
  TwinSpirals.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: Opposing animated cyan and magenta spirals.
...
Pattern currentPattern = PATTERN_SPIRALS;
