/*
  ...
  MatrixRain.ino — fully standalone SkeletonCube / CubeFX pattern demo
  Created by Dad (MysterEon) & Manus, 2026.

  Pattern: Straight-down deep emerald Matrix streams with yellow-green heads.
...
Pattern currentPattern = PATTERN_MATRIX_RAIN;
